...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED =
            "edu.stanford.cs.sing.helena.ble.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            "edu.stanford.cs.sing.helena.ble.ACTION_GATT_DISCONNECTED";
...
//        	final int heartRate = characteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT8, 0);
//            Log.d(TAG, String.format("Received random number: %d", heartRate));
